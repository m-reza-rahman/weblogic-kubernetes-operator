...
def create_domain():
  ...
  set('AcceptBacklog', 300)
  set('MaxBackoffBetweenFailures', 10000)
  set('LoginTimeoutMillis', 5000)
  set('TunnelingClientPingSecs', 45)
  set('TunnelingClientTimeoutSecs', 40)
  set('TunnelingEnabled', true)
  set('CompleteMessageTimeout', 60)
  set('TimeoutConnectionWithPendingResponse', false)
  set('IdleConnectionTimeout', 65)
  set('ConnectTimeout', 0)
  set('MaxMessageSize',1000000)
  set('OutboundEnabled', false)
  set('ChannelWeight', 50)
  set('ClusterAddress', admin_t3_public_address)
  set('Enabled', true)
  set('MaxConnectedClients', 214748367)
  set('UseFastSerialization', false)
  set('SdpEnabled', false)
