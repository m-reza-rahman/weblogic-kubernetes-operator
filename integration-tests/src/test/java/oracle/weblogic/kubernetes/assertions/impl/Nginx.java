...
public class Nginx {
   ...
   * @return callable that returns true if the NGINX pod is running, false otherwise
   */
   ...
   * @return callable that returns true if the NGINX pod is in the ready state, false otherwise
   */
