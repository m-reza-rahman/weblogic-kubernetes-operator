...
public class Traefik {
   ...
   * @return callable that returns true if the traefik pod is running, false otherwise
   */
   ...
   * @return callable that returns true if the traefik pod is in ready state, false otherwise
   */
