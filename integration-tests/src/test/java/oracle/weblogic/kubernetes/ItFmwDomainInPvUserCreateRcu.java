...
import static oracle.weblogic.kubernetes.utils.LoggingUtil.copyFromPV;
...
public class ItFmwDomainInPvUserCreateRcu {
  ...
  private static String pvNameToArchive = null;
  private static String pvcNameToArchive = null;
  ...
  public static void tearDownAll() {
    logger = getLogger();
    assertDoesNotThrow(
        () -> copyFromPV(domainNamespace,pvcNameToArchive, pvNameToArchive,
            Files.createDirectories(Paths.get(LOGS_DIR + "/ItFmwDomainInPvUserCreateRcu/pv")))
    );
  }
  ...
  void testFmwDomainOnPvUserCreatesRCUwdtConfigMap() {
    ...
    pvNameToArchive = pvName;
    pvcNameToArchive = pvcName;
    //create RCU schema
