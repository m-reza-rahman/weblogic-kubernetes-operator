...
public interface ActionConstants {
  ...
  //WDT_VERSION is used as the subdirectory identifier when we need to find out
  //from where we can locate weblogic-deploy.zip file. Right now when we install WDT
  //we always put zip file under "latest" subdirectory no matter using "latest" branch or
