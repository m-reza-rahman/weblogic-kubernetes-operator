...
import static oracle.kubernetes.operator.calls.KubernetesTestSupport.CLUSTER;
import static oracle.kubernetes.operator.calls.KubernetesTestSupport.CUSTOM_RESOURCE_DEFINITION;
import static oracle.kubernetes.operator.calls.KubernetesTestSupport.DOMAIN;
import static oracle.kubernetes.operator.calls.KubernetesTestSupport.VALIDATING_WEBHOOK_CONFIGURATION;
