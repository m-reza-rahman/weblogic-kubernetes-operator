...
export TRAEFIK_IMAGE_REGISTRY=${TRAEFIK_IMAGE_REGISTRY:-phx.ocir.io}
export TRAEFIK_IMAGE_REPOSITORY=${TRAEFIK_IMAGE_REPOSITORY:-devweblogic/test-images/traefik-ingress/traefik}
export TRAEFIK_IMAGE_TAG=${TRAEFIK_IMAGE_TAG:-v2.9.6}
