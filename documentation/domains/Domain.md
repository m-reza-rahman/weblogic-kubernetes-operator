...
| `replaceVariablesInJavaOptions` | Boolean | Specifies whether the environment variables in the Java options will be replaced in situations such as when the JAVA_OPTIONS are specified using a config map. Defaults to false. |
